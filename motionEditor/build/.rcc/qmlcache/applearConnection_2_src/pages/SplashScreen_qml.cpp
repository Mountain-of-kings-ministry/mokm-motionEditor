// /qt/qml/template/src/pages/SplashScreen.qml
...
namespace QmlCacheGeneratedCode
{
    namespace _qt_qml_template_src_pages_SplashScreen_qml
    {
        ...
        extern const unsigned char qmlData alignas(16)[] = {
            ...
            0xd8, 0x16, 0x0, 0x0, 0x1, 0x1a, 0x16, 0x51,
            0x5a, 0x73, 0xd0, 0x1d, 0x0, 0xa5, 0x5, 0xa3,
            0xee, 0xa, 0x38, 0x77, 0x0, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x23, 0x0, 0x0, 0x0,
            0x3e, 0x0, 0x0, 0x0, 0x48, 0x6, 0x0, 0x0,
            ...
            0x43, 0x3, 0x0, 0x0, 0x3, 0x3, 0x0, 0x0,
            ...
            0x23, 0x2, 0x0, 0x0, 0x81, 0x3, 0x0, 0x0,
            0x23, 0x2, 0x0, 0x0, 0xa1, 0x3, 0x0, 0x0,
            ...
            0xd0, 0x3, 0x0, 0x0, 0x90, 0x0, 0x0, 0x0,
            ...
            0xca, 0x2e, 0x10, 0x18, 0x7, 0x12, 0x39, 0x42,
            0x11, 0x7, 0x2e, 0x12, 0x18, 0x7, 0xa, 0x18,
            ...
            0x17, 0x3c, 0x18, 0x6c, 0x7, 0x50, 0x1b, 0x2e,
            0x19, 0x3c, 0x1a, 0x50, 0x15, 0x2e, 0x1b, 0x3c,
            0x1c, 0x3c, 0x1d, 0x50, 0xd, 0x2e, 0x1e, 0x18,
            0x8, 0xa, 0x18, 0x9, 0x42, 0x1f, 0x8, 0x1a,
            ...
            0x90, 0x0, 0x0, 0x0, 0xd8, 0x1, 0x0, 0x0,
            ...
            0x21, 0x0, 0x20, 0x2, 0xc, 0x0, 0x0, 0x0,
            ...
            0x28, 0x0, 0x20, 0x1, 0x11, 0x0, 0x0, 0x0,
            ...
            0x39, 0x0, 0xa0, 0x1, 0x2c, 0x0, 0x0, 0x0,
    ...
    argTypes[0] = []() { static const auto t = QMetaType::fromName("QColor"); return t; }(); },
             [](const QQmlPrivate::AOTCompiledContext *aotContext, void **argv)
             {
                 ...
                 struct Storage : QQmlPrivate::AOTTrackedLocalsStorage
                 {
                     ...
                     void markObjects(QV4::MarkStack *markStack) const final
                     {
                         Q_UNUSED(markStack);
                 ...
                 while (!aotContext->loadSingletonLookup(0, &s.v2_0))
                 {
                     ...
                     if (aotContext->engine->hasError())
                     {
                         ...
                         if (argv[0])
                         {
                             ...
                             { static const auto t = QMetaType::fromName("QColor"); return t; }();
...
// generate_GetLookup
                 ...
                 while (!aotContext->getEnumLookup(3, &s.v2_2))
                 {
                     ...
                     aotContext->setInstructionPointer(4);
#endif
                     aotContext->initGetEnumLookup(3, []()
                                                      { static const auto t = QMetaType::fromName("Qt"); return t; }().metaObject(),
                     ...
                     if (aotContext->engine->hasError())
                     {
                         ...
                         {
                             const QMetaType returnType = []()
                             { static const auto t = QMetaType::fromName("Qt::WindowFlags"); return t; }();
                             returnType.destruct(argv[0]);
                             returnType.construct(argv[0]);
                         }
                         return;
...
// generate_LoadQmlContextPropertyLookup
                 ...
                 while (!aotContext->loadScopeObjectPropertyLookup(9, &s.v2_0))
                 {
                     ...
                     if (aotContext->engine->hasError())
                     {
                         ...
                         {
                             const QMetaType returnType = []()
                             { static const auto t = QMetaType::fromName("QQuickAnchorLine"); return t; }();
                             returnType.destruct(argv[0]);
                             returnType.construct(argv[0]);
                         }
                         return;
...
// generate_GetLookup
                 ...
                 while (!aotContext->getEnumLookup(14, &s.v2_2))
                 {
                     ...
                     aotContext->setInstructionPointer(4);
#endif
                     aotContext->initGetEnumLookup(14, []()
                                                       { static const auto t = QMetaType::fromName("QQuickText*"); return t; }().metaObject(),
                                                   "HAlignment", "AlignHCenter");
                     if (aotContext->engine->hasError())
                     {
                         aotContext->setReturnValueUndefined();
                         if (argv[0])
                         {
                             const QMetaType returnType = []()
                             { static const auto t = QMetaType::fromName("QQuickText::HAlignment"); return t; }();
                             returnType.destruct(argv[0]);
                             returnType.construct(argv[0]);
                         }
                         return;
...
// generate_LoadQmlContextPropertyLookup
    ...
    argTypes[0] = QMetaType(); },
             [](const QQmlPrivate::AOTCompiledContext *aotContext, void **argv)
             {
                 Q_UNUSED(aotContext)
                 Q_UNUSED(argv)
                 // expression for onTriggered at line 47, column 9
                 struct Storage : QQmlPrivate::AOTTrackedLocalsStorage
                 {
                     Storage(const QQmlPrivate::AOTCompiledContext *ctxt, void **a) : aotContext(ctxt), argv(a) {}
                     void markObjects(QV4::MarkStack *markStack) const final
...
// generate_LoadQmlContextPropertyLookup
                     ...
                     s.v2_5 = QUrl(QStringLiteral("Main.qml"));
                     {
                     }
                     // generate_SetLookup
                     {
...
#endif
                         while (!aotContext->setObjectLookup(19, s.v2_10, &s.v2_14))
                         {
#ifdef QT_NO_DEBUG
                             aotContext->setInstructionPointer(20);
#endif
                             aotContext->initSetObjectLookup(19, s.v2_10);
                             if (aotContext->engine->hasError())
                             {
                                 aotContext->setReturnValueUndefined();
                                 return;
